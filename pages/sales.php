...
<head>
    ...
    * {
    ...
    /* Final Find Sales responsive guardrails */
    .filter-panel,
    .filter-panel * {
        box-sizing: border-box;
    }
...
<body>
    ...
    /* =========================================================
       FIND SALES — CLEAN RESPONSIVE LAYOUT
       ========================================================= */
    .filter-panel {
        width: 100%;
        max-width: 100%;
    ...
    /* Desktop: period + date + category on first row;
       search + actions on second row. */
    .filter-body {
        display: grid !important;
        grid-template-columns: minmax(0, 1.35fr) minmax(180px, .75fr) minmax(190px, .8fr);
        gap: 16px;
        align-items: end;
        width: 100%;
        box-sizing: border-box;
    ...
    .filter-body > div:nth-child(3) {
        grid-column: 1 / -1;
    }

    .filter-body > div:nth-child(5) {
        grid-column: 1 / 3;
    }
    ...
    @media (max-width: 1000px) {
        ...
        .filter-body > div:nth-child(1) {
            grid-column: 1 / -1;
        }

        .filter-body > div:nth-child(2) {
            grid-column: 1;
        }
