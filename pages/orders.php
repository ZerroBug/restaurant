...
<head>
    ...
    * {
    ...
    /* =========================================================
   FINAL ORDERS PAGE — ELEGANT PROFESSIONAL POLISH
   ========================================================= */
    :root {
        --order-orange: #f58220;
        --order-orange-dark: #d96610;
        --order-ink: #24211f;
        --order-muted: #81786f;
        --order-border: #ebe5df;
    ...
    .metric {
        ...
        box-shadow: 0 5px 16px rgba(40, 30, 22, .08) !important
    }
    ...
    .hero {
        min-height: 315px;
        border-radius: 15px;
        box-shadow: 0 10px 28px rgba(40, 30, 22, .07)
    }
    ...
    .popular-panel {
        border-radius: 15px;
        box-shadow: 0 8px 25px rgba(40, 30, 22, .05)
    }
    ...
    .panel {
        border-radius: 14px;
        box-shadow: 0 7px 22px rgba(40, 30, 22, .045)
    }
    ...
    .snapshot-card {
        ...
        box-shadow: 0 5px 16px rgba(45, 32, 23, .035) !important
    }
